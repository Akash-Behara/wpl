...
const Hero = () => {
  return (
    <div className='min-h-screen'>
      <div>
        <img src={heroBg} className='absolute top-0 left-0 size-full bg-cover bg-center bg-blend-luminosity' />
      </div>

      <div className='bg-[#16237f]/60 size-full min-h-screen z-30 relative'>
        ...
        <div className='flex flex-col justify-center items-center mt-[100px]'>
          <div className='max-w-[1000px] flex flex-col justify-center items-center relative'>
            <h1 className='font-gridular text-[55px] lg:text-[6.98em] text-primary text-center md:leading-[125px] uppercase'>Break Boundaries, 
            ...
            <p className='font-bienvenue text-white mt-6 md:text-[20px] leading-5'>Apply now and complete mission to earn money</p>
            ...
            <img src={bgYellowElLeft} alt='yellow element' className='absolute bottom-5 -left-14 size-14'/>
            <img src={bgYellowElRight} alt='yellow element' className='absolute -top-6 lg:-top-3 right-0 md:-right-3 size-14'/>
          </div>
